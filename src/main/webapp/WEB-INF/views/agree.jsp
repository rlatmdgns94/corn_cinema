...
<body>
    <div class="main-agree-wrap">
        <form action="#" method="POST" id="agree_form" name="">
            ...
            <div class="agreement-wrap">
                <div class="agreement-box">
                    <div class="agreement">
                        ...
                        <span><input type="checkbox"> 위의 ‘이용약관’을 읽고 동의 합니다. (필수 동의)</span>
                    </div>
                    <div class="agreement">
                        <h3>개인정보수집 및 이용안내</h3>
                        <div class="agreement-text">
                        ...
                        <span><input type="checkbox" name="" value=""> 위의 ‘개인정보수집 및 이용안내’을 읽고 동의 합니다. (필수
                            동의)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="join-button-wrap">
                <input type="submit" value="다음" class="join-button join-submit">
            </div>
        </form>
    </div>
</body>
