...
<body>
    ...
    <div class="main-join-wrap">
        <form class="join-form" action="/member/member_modify" method="POST">
            ...
            <input type="hidden" title="updatedate" id="updatedate" name="updatedate" value=${login.updatedate}>
               ...
               ${login.name}
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="phone" title="휴대폰" id="phone" name="phone" required="" value= ${login.phone} >
                            </td>
                        </tr>
                        <tr>
